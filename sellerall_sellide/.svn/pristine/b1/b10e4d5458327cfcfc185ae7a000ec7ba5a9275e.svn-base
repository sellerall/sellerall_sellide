...
import kr.co.sellerall.sys.controller.MenuMgmtController;
...
public class CrawlerController {
	...
	public String crawler(Model model,HttpServletResponse res ,@LoginUser SessionUser user) throws Exception {
		logger.debug("crawler 컨트롤러");
		if(user != null){
