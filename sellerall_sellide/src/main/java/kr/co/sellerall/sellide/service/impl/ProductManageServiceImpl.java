...
public class ProductManageServiceImpl implements ProductManageService {
	...
	public String naverUserInfo(Map cookies) {
		...
		try {
			Connection.Response res1 = Jsoup.connect("https://sell.smartstore.naver.com/api/products?_action=create")
					.method(Method.GET)
					.cookies(cookies)
	...
	@Override
	public void naverProductUpload(Object request, Map cookies) {
		try {
